package com.f1soft.authservice.feignInterface;

import com.f1soft.authservice.responseDTO.AdminResponseDTO;
...
import static com.f1soft.authservice.constants.MicroServiceConstants.*;
